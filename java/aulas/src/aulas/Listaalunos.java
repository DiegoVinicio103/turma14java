...
public class Listaalunos {
	...
	public static void main(String[] args) {
		...
		for (int x = 0; x < 40; x++) {
			if (genero[x]=='M'){
					System.out.println("Matrícula: "+matriculaFinal[x]+" Gênero: "+genero[x]+" Aluno: "+nomeAlunos[x]);
			}
			else  {
				System.out.println("Matrícula: "+matriculaFinal[x]+" Gênero: "+genero[x]+" Aluna: "+nomeAlunos[x]);
		}
		}
